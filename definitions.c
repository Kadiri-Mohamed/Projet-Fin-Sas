...
Produit produits[] = {
    ...
    {3, "Aspirateur Robot", {2, "Maison"}, 299.99, 20, "Un aspirateur robot intelligent pour un nettoyage sans effort."},
    {4, "Lampe de Bureau", {2, "Maison"}, 49.99, 100, "Une lampe de bureau LED avec intensité réglable."},
};
